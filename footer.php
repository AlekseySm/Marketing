        ...
        <div class="footer__main">
            ...
            <div class="footer__wrapper footer__wrapper--col">
                <ul class="footer__nav">
                    <li><a href="<?php echo site_url(); ?>/#about-us">Services</a></li>
                    <li><a href="<?php echo site_url(); ?>/#services">About Us</a></li>
                </ul>
                <ul class="footer__social">
                    <li>
                        <a href="<?php the_field('instagram', 'options'); ?>" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22.927" height="22.187"
                                 viewBox="0 0 22.927 22.187">
                                <defs>
                                    <style>
                                        .inst_a,
                                        .inst_d {
                    ...
                    <li>
                        <a href="<?php the_field('facebook', 'options'); ?>" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="11.094" height="22.187"
                                 viewBox="0 0 11.094 22.187">
                                <defs>
                                    <style>
                                        .face_a {
                                            fill: #fff;
                                ...
                                <path class="face_a"
                                      d="M134.934,7.627V4.853a1.387,1.387,0,0,1,1.387-1.387h1.387V0h-2.773a4.16,4.16,0,0,0-4.16,4.16V7.627H128v3.467h2.773V22.187h4.16V11.094h2.773l1.387-3.467Z"
                    ...
                    <li>
                        <a href="<?php the_field('linkedin', 'options'); ?>" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22.261" height="22.188"
                                 viewBox="0 0 22.261 22.188">
                                <defs>
                                    <style>
                                        .lin_a {
                                            fill: #fff;
                                ...
                                <g transform="translate(7.056 6.983)">
                                    <path class="lin_a"
                                          d="M171.506,160.178c-.053-.017-.1-.035-.158-.05s-.133-.028-.2-.039a4.433,4.433,0,0,0-.887-.09,6.871,6.871,0,0,0-5.315,2.907V160H160v15.2h4.946v-8.293s3.738-5.205,5.315-1.382V175.2H175.2v-10.26A4.931,4.931,0,0,0,171.506,160.178Z"
